...
/*
NOTE: TO THE DEVELOPER READING THIS, THIS IS A SMART CONTRACT HARD CODED WITH VALUES TO MAKE TESTING GO
FASTER. PLEASE DO NOT INTERACT WITH THIS WHATSOEVER.
*/
...
contract TestOmegaLottery is VRFConsumerBaseV2Plus, AutomationCompatibleInterface
{
    ...
    // LOTTERY CREATION
    function createLottery(uint256 entryFee) external onlyOwner returns (uint256 lotteryId) 
    {
        // enforce rules
    ...
    function setTreasury(address newTreasury) external onlyOwner 
    {
        ...
        emit TreasuryUpdated(treasuryAddress, newTreasury);
